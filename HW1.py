...
muinc = df2['incwage'].mean()  # '$42,112.44 average income'
print(muinc.round(2))
...
# (i) Sample mean
smu = df3.incwage.mean()  # '$43,402.09 average income sample'
print(smu.round(2))

# (ii) Sample Standard Deviation
sigma = df3.incwage.std()  # '$39,111.74'
print(sigma.round(2))

# (iii) Standard Error
SE = sigma/np.sqrt(1000)  # '1236.82'
print(SE.round(2))
...
print((smu-CI95).round(2))  # '40975.02'

# Upper end of the range
print((smu+CI95).round(2))  # '45829.16'

# (v) Ho m0 = 50,000 ; H1 m1 =! 50,000
ttest = (smu - 50000)/SE  # '5.33 which is greater than t, thus reject null'
# alpha is ifinitibly small as well
print(ttest.round(2))
# (vi) Ho m = 55,000 ; H1 m =! 50000
ttest = (smu - 55000)/SE  # '9.38 thus reject Ho and alpha is very small'
print(ttest.round(2))
